...
var v = class extends m {
  constructor(e, t) {
    super("missing_refresh_token", `Missing Refresh Token (audience: '${k(e, ["default"])}', scope: '${k(t)}')`), this.audience = e, this.scope = t, Object.setPrototypeOf(this, v.prototype);
  }
};
function k(e, t = []) {
...
var O = class {
  ...
  static fromKey(e) {
    ...
    return new O({ clientId: i, scope: n2, audience: o }, t);
  }
  static fromCacheEntry(e) {
    const { scope: t, audience: i, client_id: o } = e;
    return new O({ scope: t, audience: i, clientId: o });
  }
};
var X = class {
  set(e, t) {
